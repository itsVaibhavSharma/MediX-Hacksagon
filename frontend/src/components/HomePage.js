...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      setStats(prev => ({
        totalUsers: Math.min(prev.totalUsers + 50, 2500),
        diagnosesCompleted: Math.min(prev.diagnosesCompleted + 100, 15000),
        accuracyRate: Math.min(prev.accuracyRate + 1, 94)
      }));
    }, 50);
  ...
  const aiModels = [
    ...
    { name: "Nail Disease", icon: "💅", accuracy: "88%", conditions: "6 conditions" },
  ...
  const testimonials = [
    {
      ...
      role: "Dermatologist",
      comment: "MediX has revolutionized how I provide preliminary assessments to my patients.",
      avatar: "👩‍⚕️"
    },
    {
      name: "Michael Chen",
      role: "Patient",
      comment: "The AI diagnosis gave me peace of mind before visiting my doctor. Incredibly accurate!",
      avatar: "👨"
    },
    {
      name: "Dr. Raj Patel",
      role: "Radiologist",
      comment: "The bone fracture detection model is impressively accurate and saves valuable time.",
      avatar: "👨‍⚕️"
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-white space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to="/signup"
                  className="inline-flex items-center justify-center px-8 py-4 bg-white text-blue-600 rounded-xl font-semibold hover:bg-blue-50 transition-all duration-300 transform hover:scale-105 shadow-lg"
                >
                  Get Started Free
              ...
              <div className="grid grid-cols-3 gap-8 pt-8 border-t border-blue-400">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold">{stats.diagnosesCompleted.toLocaleString()}+</div>
                  <div className="text-blue-200 text-sm">Diagnoses</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold">{stats.accuracyRate}%</div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-gray-600">Trusted by patients and doctors worldwide</p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-700">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-12 border-t border-blue-400">
